...
Word_Type_Table = Table.read(Table_PATH+'Word_Type_Table.hdf5', path='Word_Type_Table')
Top_One_Hundred_Table = Table.read(Table_PATH+'Top_One_Hundred_Table.hdf5', path='Top_One_Hundred_Table')
			...
			if processed:
				...
				try:
					...
					for i, key in enumerate(Word_Type_Table.keys()):
						...
						ax.scatter(Word_Type_Table['time'],Word_Type_Table[key],c=plt_clrs[i])
